...
|----------------|----------|--------|-------------------|
| **TCP соединение** | Стандартное TCP соединение по IP и порту | `192.168.1.100:9000` | Разные машины |
| **Unix сокеты** | Локальные Unix-сокеты для быстрой передачи | `/var/run/wireshark.sock` | Одна машина |
